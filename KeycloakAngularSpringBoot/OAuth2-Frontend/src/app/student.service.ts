...
export class StudentService {
  ...
  addStudent(hero: Student): Observable<Student> {
    return this.http.post<Student>(this.studentsUrl, hero, this.httpOptions).pipe(
      tap((newHero: Student) => this.log(`added hero w/ id=${newHero.id}`)),
  ...
  updateHero(hero: Student): Observable<any> {
    return this.http.put(this.studentsUrl, hero, this.httpOptions).pipe(
